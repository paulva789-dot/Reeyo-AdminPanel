...
export const ENDPOINTS = {
  ...
  trackingFact: (id: string) => `/engagement/tracking-facts/${id}`,
  preferenceTags: '/engagement/preference-tags',
  preferenceTag: (tag: string) => `/engagement/preference-tags/${encodeURIComponent(tag)}`,
  loyaltyRules: '/engagement/loyalty/rules',
  loyaltyRule: (id: string) => `/engagement/loyalty/rules/${id}`,
  loyaltyRewards: '/engagement/loyalty/rewards',
  loyaltyReward: (id: string) => `/engagement/loyalty/rewards/${id}`,
  loyaltyAccount: (userId: string) => `/engagement/loyalty/accounts/${userId}`,
  loyaltyLedger: (userId: string) => `/engagement/loyalty/accounts/${userId}/ledger`,
  spinWheels: '/engagement/spin-wheels',
  spinWheel: (id: string) => `/engagement/spin-wheels/${id}`,
  spinWheelSegments: (id: string) => `/engagement/spin-wheels/${id}/segments`,
  spinWheelSegment: (id: string, segmentId: string) =>
    `/engagement/spin-wheels/${id}/segments/${segmentId}`,
  spinWheelResults: (id: string) => `/engagement/spin-wheels/${id}/results`,
  popups: '/engagement/popups',
  popup: (id: string) => `/engagement/popups/${id}`,
  popupStats: (id: string) => `/engagement/popups/${id}/stats`,
