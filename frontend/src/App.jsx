...
const MenuApprovals = React.lazy(() => import('./pages/Users/Vendors/menuApprove/MenuApprovals.jsx')); 
const RiderManagement = React.lazy(() => import('./pages/Users/DeliveryGuys/RiderManagement.jsx'));
const OrderManagement = React.lazy(() => import('./pages/Orders/OrderManagement.jsx'));
const LiveTracker = React.lazy(() => import('./pages/Logistics/LiveTracker/LiveTracker.jsx')); 
...
const ForgetPasswordPage = React.lazy(() => import('./pages/Auth/ForgotPasswordPage.jsx'));

// CMS
const CMSCustomersPage = React.lazy(() => import('./pages/CMS/CustomersPage.jsx'));
...
        
        {/* Functional Pages */}
        <Route path="/orders" element={<ProtectedRoute element={OrderManagement}/>} />
        <Route path="/users/vendors/approvals" element={<ProtectedRoute element={MenuApprovals}/>} />
        
        {/* Logistics Routes */}
...
        {/* CMS Route */}
        <Route path="/cms/customers" element={<ProtectedRoute element={CMSCustomersPage} />} />
